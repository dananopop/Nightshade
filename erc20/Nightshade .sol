...
/**
* @title Nightshade Token
**/
contract NightshadeToken is ERC20, Pauseable {
    ...
    string public constant name = "Nightshade";
    string public constant symbol = "Nightshade";
    uint8 public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY =   500000000 * (10 ** uint256(decimals));
    
    function NightshadeToken() public {
        owner = msg.sender;
